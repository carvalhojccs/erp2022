    ...
    <div class="rows">	
        <div class="col-12">
            <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
                ...
                <div>
                    <a href="{{ route('products.create') }}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                ...
                <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><img src="{{ asset("storage/$item->image") }}" class="img-fluido"></td>
                            <td align="left">{{ $item->name }}</td>
                            <td align="center">R$ {{ number_format($item->price,2,',','.') }}</td>
